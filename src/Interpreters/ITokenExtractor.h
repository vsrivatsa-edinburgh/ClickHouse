...
struct ITokenExtractor
{
    ...
    virtual void
    substringToBloomFilter(const char * data, size_t length, BloomFilter & bloom_filter, bool /*is_prefix*/, bool /*is_suffix*/) const
    {
        stringToBloomFilter(data, length, bloom_filter);
    }

    virtual void
    substringToSurfFilter(const char * data, size_t length, SurfFilter & surf_filter, bool /*is_prefix*/, bool /*is_suffix*/) const
    {
    ...
    /// tokens depending on whether the substring is a prefix or a suffix.
    virtual void
    substringToGinFilter(const char * data, size_t length, GinFilter & gin_filter, bool /*is_prefix*/, bool /*is_suffix*/) const
    {
...
{
    explicit NgramTokenExtractor(size_t n_)
        : n(n_)
    {
    }
