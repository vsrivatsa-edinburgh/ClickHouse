...
struct MergeTreeIndexGranuleSurfFilterText final : public IMergeTreeIndexGranule
{
    ...
    const SurfFilterParameters params;

    std::vector<SurfFilter> surf_filters;
    bool has_elems;
};

using MergeTreeIndexGranuleSurfFilterTextPtr = std::shared_ptr<MergeTreeIndexGranuleSurfFilterText>;
...
class MergeTreeConditionSurfFilterText final : public IMergeTreeIndexCondition
{
public:
...
private:
    ...
    bool tryPrepareSetSurfFilter(const RPNBuilderTreeNode & left_argument, const RPNBuilderTreeNode & right_argument, RPNElement & out);

    static bool createFunctionEqualsCondition(
        RPNElement & out, const Field & value, const SurfFilterParameters & params, TokenExtractorPtr token_extractor);
...
class MergeTreeIndexSurfFilterText final : public IMergeTreeIndex
{
public:
